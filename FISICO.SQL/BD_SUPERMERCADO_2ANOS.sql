CREATE DATABASE IF NOT EXISTS BD_SUPERMERCADO_2ANOS;
USE BD_SUPERMERCADO_2ANOS;
...
CREATE TABLE IF NOT EXISTS SUPERMERCADO_PRODUTO(
    ...
    FOREIGN KEY (FK_SUPERMERCADO_CNPJ) REFERENCES SUPERMERCADO(CNPJ),
    FOREIGN KEY (FK_PRODUTOS_IDJ) REFERENCES PRODUTOS(ID)
);
...
-- ALTERAR TABELA CONSUMIDOR, ADICONAR DATA_NASCIMENTO
...
-- ALTERAR TABELA SUPERMERCADO, MOFICAR COLUNA LOGRADOURO
ALTER TABLE SUPERMERCADO
...
DROP DATABASE BD_SUPERMERCADO_2ANOS;
